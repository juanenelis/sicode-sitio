      ...
      <div style={{ width: "100%", maxWidth: 900, background: tema.fondoPagina, borderRadius: 24, padding: "22px 22px 30px" }}>
        ...
        {tab === "cursos" && sesion.rol === "maestro" && (
          <MisCursosMaestro
            ...
            cursoInvitadoId={cursoInvitadoId} setCursoInvitadoId={setCursoInvitadoId}
          />
        )}
...
function MisCursosMaestro({ sesion, centro, cursos, todosCursos, setCursos, usuarios, setUsuarios, enviarCorreo, cursoInvitadoId, setCursoInvitadoId }) {
