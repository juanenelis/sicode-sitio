...
function PersonalTab({ sesion, centro, staff, setUsuarios, enviarCorreo }) {
  ...
  const agregar = async (e) => {
    ...
    setUltimo({ nombre, correoLogin, passwordTemporal, correoEnviado: resultado.ok });
  ...
  const enviarInvitacion = async (e) => {
    ...
    setEnviandoCorreo(false);
    setUltimoInv({ correoLogin, passwordTemporal, correoEnviado: resultado.ok });
    setCorreoInv("");
  };
        ...
        <div style={{ background: C.panel, border: `1px solid ${C.line}`, borderRadius: 14, padding: 18, marginBottom: 18, display: "flex", flexDirection: "column", gap: 11 }}>
          ...
          {ultimo && (
            <OkBox>
              ...
              {" "}{ultimo.correoEnviado ? "✅ Correo enviado a su bandeja." : "⚠️ No pudimos enviar el correo automático — comparte estos datos manualmente."}
            </OkBox>
          )}
        </div>
      )}
        ...
        <div style={{ background: C.panel, border: `1px solid ${C.line}`, borderRadius: 14, padding: 18, marginBottom: 18, display: "flex", flexDirection: "column", gap: 11 }}>
          ...
          {ultimoInv && (
            <OkBox>
              ...
              {" "}{ultimoInv.correoEnviado ? "✅ Correo enviado a su bandeja." : "⚠️ No pudimos enviar el correo automático — comparte estos datos manualmente."}
            </OkBox>
          )}
        </div>
      )}
...
function EstudiantesCurso({ centro, curso, estudiantes, setUsuarios, enviarCorreo }) {
  ...
  const agregar = async (e) => {
    ...
    setUltimo({ nombre, correoLogin, passwordTemporal, correoEnviado, teniaCorreo: !!correo.trim() });
        ...
        <div style={{ background: C.panel, border: `1px solid ${C.line}`, borderRadius: 12, padding: 16, marginBottom: 16, display: "flex", flexDirection: "column", gap: 9 }}>
          ...
          {ultimo && (
            <OkBox>
              ...
              {" "}{!ultimo.teniaCorreo ? "No pusiste correo, así que compártele estos datos tú mismo." : ultimo.correoEnviado ? "✅ Correo enviado a su bandeja." : "⚠️ No pudimos enviar el correo automático — comparte estos datos manualmente."}
            </OkBox>
          )}
        </div>
      )}
